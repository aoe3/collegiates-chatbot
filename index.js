...
function sendBeginner(sender){
    ...
    "attachment": {
      ...
      "payload": {
        ...
        "elements": [
          {
            "title": "Swipe left/right for more options. On browser, click arrows in bubble below.",
            "buttons": [
              {
                "type": "postback",
                "title": "Beg Changquan",
          ...
          {
            "title": "Swipe left/right for more options. Browser: click on arrows in bubble below.",
            "buttons": [
              {
                "type": "postback",
                "title": "Beg Open Yang",
