...
function sendBeginner(sender){
    ...
    "attachment": {
      ...
      "payload": {
        ...
        "elements": [
          {
            "title": "Swipe left/right for more beginner options. On browser, move cursor over options to see arrows.",
            "buttons": [
              {
                "type": "postback",
                "title": "Beg Changquan",
  ...
  let messageData = {
    "attachment": {
      ...
      "payload": {
        ...
        "elements": [
          {
            "title": "Swipe left/right for more intermediate options. On browser, move cursor over options to see arrows.",
            "buttons": [
              {
                "type": "postback",
                "title": "Int Changquan",
...
function sendAdvanced(sender){
    ...
    "attachment": {
      ...
      "payload": {
        ...
        "elements": [
          {
            "title": "Swipe left/right for more advanced options. On browser, move cursor over options to see arrows.",
            "buttons": [
              {
                "type": "postback",
                "title": "Adv CQ Nandu",
